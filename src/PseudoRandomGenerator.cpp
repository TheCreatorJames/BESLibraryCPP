...
PseudoRandomGenerator::PseudoRandomGenerator() :
    PseudoRandomGenerator(16 * 1024)
{
}

PseudoRandomGenerator::PseudoRandomGenerator(int size) :
    PseudoRandomGenerator(size, GetRandomness())
{
}

PseudoRandomGenerator::PseudoRandomGenerator(int size, string pass) :
    PseudoRandomGenerator(size, pass, 400)
{
}

PseudoRandomGenerator::PseudoRandomGenerator(int size, string pass, int rounds) :
    PseudoRandomGenerator(size, pass, rounds, make_shared<BasylPseudoAdaptor> ())
{
}
...
unsigned __int64 PseudoRandomGenerator::SeedFunction(unsigned __int64 pos,
