...
template <class T>
BasylArray<T>::BasylArray(int size) : data(new T[size]()), len(size)
{
}

template <class T>
BasylArray<T>::BasylArray() : data(nullptr), len(0)
{
...
template <class T>
BasylArray<T>::BasylArray(T* arr, int size) : data(new T[size]()), len(size)
{
...
template <class T>
BasylArray<T>::BasylArray(const BasylArray<T>& c) : data(new T[c.size()]()), len(c.size())
{
